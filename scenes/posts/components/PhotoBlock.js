...
export default function PhotoBlock({visible, setVisible, plus, imageData, photo, minus}) {
      ...
      {imageData&&
        ...
        <div>
          <ButtonClose onClick={()=>setVisible(false)}/>
            ...
            <Image src={'https://cdn-icons-png.flaticon.com/512/1/1627.png'} width={40} height={40}/>
            </div>
            <div className="flex items-center w-full justify-center">
            <Image src={imageData[photo]} width={500} height={500}/>
            </div>
            <div className="flex items-center justify-end cursor-pointer" onClick={plus}>
            <Image src={'https://cdn-icons-png.flaticon.com/512/57/57116.png'} width={40} height={50}/>
            </div>
            </div>
